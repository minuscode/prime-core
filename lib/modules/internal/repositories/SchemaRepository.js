...
let SchemaRepository = class SchemaRepository extends DataLoaderRepository_1.DataLoaderRepository {
};
SchemaRepository = __decorate([
    typeorm_1.EntityRepository(Schema_1.Schema)
], SchemaRepository);
