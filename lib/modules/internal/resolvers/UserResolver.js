...
let UserResolver = class UserResolver {
  ...
  getUser(context) {
    return __awaiter(this, void 0, void 0, function* () {
      const meta = yield User_1.User.meta(context.user.id);
      return Object.assign(Object.assign({}, context.user), {
        meta,
  ...
  allUsers(
    ...
    result.resolveNode = (user) =>
      __awaiter(this, void 0, void 0, function* () {
        user.emails = yield this.userEmailRepository.find({ user });
        const meta = yield User_1.User.meta(user.id);
        return Object.assign(Object.assign({}, user), { meta });
      });
    return result;
  }
  createPrimeUser(email, maybePassword, profile) {
    return __awaiter(this, void 0, void 0, function* () {
      const password = graphql_api_1.AccountsModule.injector.get(
        password_1.default
      );
  ...
  changeEmail(password, email, context) {
    return __awaiter(this, void 0, void 0, function* () {
      const accounts = graphql_api_1.AccountsModule.injector.get(
        password_1.default
      );
      ...
      if (user) {
        ...
        processWebhooks_1.processWebhooks('user.emailAdded', {
          userId: user.id,
          email,
        });
        return true;
  ...
  updateUser(id, input, context) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const meta = yield User_1.User.meta(id);
      meta.profile = input.profile;
      ability_1.ForbiddenError.from(context.ability).throwUnlessCan(
        'update',
        user
      );
  ...
  meta(user) {
    return User_1.User.meta(user.id);
  }
};
__decorate(
  [
...
__decorate(
  [
    typeorm_typedi_extensions_1.InjectRepository(
      UserMetaRepository_1.UserMetaRepository
    ),
...
__decorate(
  [
    ...
    __param(
      0,
      type_graphql_1.Arg('id', (type) => type_graphql_1.ID)
    ),
...
__decorate(
  [
    ...
    __metadata('design:paramtypes', [
      createConnectionType_1.ConnectionArgs, //
    ]),
    __metadata('design:returntype', void 0),
  ],
  UserResolver.prototype,
...
__decorate(
  [
    ...
    __param(
      2,
      type_graphql_1.Arg('profile', (type) => graphql_type_json_1.default, {
        nullable: true,
      })
    ),
    __metadata('design:type', Function),
...
__decorate(
  [
    ...
    __param(
      1,
      type_graphql_1.Arg('input', (type) => UpdateUserInput_1.UpdateUserInput)
    ),
    __param(2, type_graphql_1.Ctx()),
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [
      String,
      UpdateUserInput_1.UpdateUserInput,
      Object,
    ]),
    __metadata('design:returntype', Promise),
  ],
