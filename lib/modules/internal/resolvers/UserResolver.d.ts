...
export declare class UserResolver {
    ...
    createPrimeUser(email: string, maybePassword: string, profile: any): Promise<boolean>;
    changeEmail(password: string, email: string, context: Context): Promise<boolean>;
    updateUser(id: string, input: UpdateUserInput, context: Context): Promise<User>;
